...
namespace Demo
{
    static class Sms
    {
        ...
        const String accessKeyId = "LTAI4XORtBeu9M0N";
        const String accessKeySecret = "C8RbqtHKlI2auHIJqjMY1UN9iCUphg";
        public static SendSmsResponse sendSms()
        {
            ...
            try
            {
                ...
                //request.PhoneNumbers = "13710218209";
                ////必填:短信签名-可在短信控制台中找到
                //request.SignName = "感知万物";
                ////必填:短信模板-可在短信控制台中找到
                //request.TemplateCode = "SMS_137656942";
                ////可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
                //request.TemplateParam = "{\"moduleName\":\"123\"}";
                ...
                // 18980032628‬,15928105390‬,13880708919‬,15198044594‬,18581876666‬,18688096520
                request.PhoneNumbers = "18688096520"; // "18980032628‬"; //15198044594,13880708919‬,18581876666‬,15928105390‬,18688096520
                //必填:短信签名-可在短信控制台中找到
                request.SignName = "感知万物";
                //必填:短信模板-可在短信控制台中找到
                request.TemplateCode = "SMS_137656977";
                //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
                request.TemplateParam = JsonHelper.Serialize(obj);  //
                //可选:outId为提供给业务方扩展字段,最终在短信回执消息中将此值带回给调用者
                request.OutId = "21212121211"; //"yourOutId";
                //请求失败这里会抛ClientException异常
        ...
        public static SendBatchSmsResponse sendSms(string aa)
        {
            IClientProfile profile = DefaultProfile.GetProfile("cn-hangzhou", accessKeyId, accessKeySecret);
            DefaultProfile.AddEndpoint("cn-hangzhou", "cn-hangzhou", product, domain);
