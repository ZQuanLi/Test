...
namespace DataProcess
{
    public class FileLog
    {
        ...
        {
            Write_Log("Ssr", content,"logs.log");
        }
        ...
        private static void Write_Log(string type, string content,string fileName = "")
        {
            try
            {
                ...
                {
                    filePath = AppDomain.CurrentDomain.BaseDirectory + @"/logs_sys";
                    if (System.IO.Directory.Exists(filePath) == false)
                        System.IO.Directory.CreateDirectory(filePath);
