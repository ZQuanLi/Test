...
namespace YDS6000.BLL.Report
{
    ...
    {
        public DataTable GetRptRoomSightList(int areaId, DateTime start, DateTime end, int roomSightId)
        {
            #region 表结构
            DataTable dtRst = new DataTable();
            dtRst.Columns.Add("RoomId", typeof(System.Int32));// 站点ID号
            dtRst.Columns.Add("RoomSightId", typeof(System.Int32));// 场景类型ID号
            ...
            dtRst.Columns.Add("RoomSightName", typeof(System.String));// 场景类型名称
            ...
            DataTable dtSource = dal.GetRptRoomSightData(areaId, roomSightId);
            dtRst.PrimaryKey = new DataColumn[] { dtRst.Columns["RoomId"] , dtRst.Columns["RoomSightId"] };
            ...
            foreach (DataRow dr in dtSource.Rows)
            {
                ...
                DataRow addDr = dtRst.Rows.Find(new object[] { dr["Co_id"], dr["RoomSightId"] });
                if (addDr == null)
                {
                    addDr = dtRst.NewRow();
                    addDr["RoomId"] = dr["Co_id"];
                    addDr["RoomSightId"] = dr["RoomSightId"];
                    ...
                    addDr["RoomSightName"] = dr["RoomSightName"];
            ...
            foreach (DataRow dr in dtUse.Rows)
            {
                ...
                DataRow addDr = dtRst.Rows.Find(new object[] { curDr["Co_id"], curDr["RoomSightId"] });
